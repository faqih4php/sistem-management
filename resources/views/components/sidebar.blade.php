          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item {{ request()->routeIs('roles.*') ? 'open' : '' }}">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link {{ request()->routeIs('roles.index') ? 'active' : '' }}" href="{{ route('roles.index') }}">
                      <span class="nav-main-link-name">List Role</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
                    <a class="nav-main-link {{ request()->routeIs('roles.create') ? 'active' : '' }}" href="{{ route('roles.create') }}">
