                        ...
                        <div class="col-lg-10 col-xl-10">
                            ...
                            <div class="mb-4 row">
                                <div class="start_date col-lg-6">
                                    ...
                                    @enderror"
                                        ...
                                        data-date-format="Y-m-d" data-alt-format="F j, Y" value="{{ old('start_date', $project->start_date) }}">
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="end_date col-lg-6">
                                    ...
                                    @enderror"
                                        ...
                                        data-date-format="Y-m-d" data-alt-format="F j, Y" value="{{ old('end_date', $project->end_date) }}">
                                    @error('end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    id="description" name="description" rows="4" placeholder="Description">{{ old('description', $project->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-4">
                                ...
                                <select class="js-select2 form-control @error('user') is-invalid @enderror"
                                    id="user[]" name="user[]" style="width: 100%;" data-placeholder="Choose at least two.." multiple>
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" {{ $project->user->contains($user->id) ? 'selected' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select form-control" id="status" name="status">
                                    ...
                                    <option value="3" {{ $project->status == 'finished' ? 'selected' : '' }}>Finished</option>
                                </select>
                            </div>
                            <div class="row items-push">
                                <div class="col-lg-7">
