<x-layout>
    ...
    <div class="content">
                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 50px;">List Tasks</th>
                                ...
                                <td class="fw-semibold fs-sm">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="" class="btn btn-sm btn-alt-info" data-bs-toggle="modal"
                                            data-bs-target="#modal-description-{{ $project->id }}"
        ...
        {{-- Modals --}}
        @foreach ($projects as $project)
            <div class="modal" id="modal-description-{{ $project->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal" id="modal-detail-{{ $project->id }}" tabindex="-1" role="dialog"
