                        ...
                        <div class="col-lg-10 col-xl-10">
                            ...
                            <div class="mb-4 row">
                                <div class="start_date col-lg-6">
                                    ...
                                    @enderror"
                                        ...
                                        data-date-format="Y-m-d" data-alt-format="F j, Y" value="{{ old('start_date', $task->start_date) }}">
                                    @error('start_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="end_date col-lg-6">
                                    ...
                                    @enderror"
                                        ...
                                        data-date-format="Y-m-d" data-alt-format="F j, Y" value="{{ old('end_date', $task->end_date) }}">
                                    @error('end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    ...
                                    id="description" name="description" rows="4" placeholder="Description">{{ old('description', $task->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
